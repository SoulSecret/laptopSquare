...
<body class="w3-mobile w3-sans-serif login">
  ...
  <div class="w3-container w3-padding w3-display-middle w3-text-white w3-white w3-card-4" style="width:400px">
    <form method="post">
        <h2 class="w3-center w3-monospace w3-wide w3-text-black"><b>Code Verification</b></h2>
                   <?php 
                    if(isset($_SESSION['info'])){
                        ?>
                        <div class="w3-panel w3-pale-green w3-padding-small w3-center w3-text-black w3-monospace w3-margin-bottom" style="padding: 0.4rem 0.4rem">
                    ...
                    if(count($errors) > 0){
                        ?>
                        <div class="w3-panel w3-pale-red w3-padding-small w3-center w3-text-black w3-monospace w3-margin-bottom">
                            <?php
  ...
  <div class="w3-container w3-cell w3-bottommiddle">
    <input class="w3-input w3-border w3-border-green w3-margin-left" type="number" name="otp" placeholder="Enter code" style="width:300px" required>
  <button type="submit" name="check-reset-otp" class="w3-center w3-panel w3-green w3-padding w3-half w3-margin-top w3-center w3-margin-left w3-left w3-text-black w3-hover-green" style="width:300px"><b>Submit</b></button>
</div>
   </form>
   </div>
 </div>
