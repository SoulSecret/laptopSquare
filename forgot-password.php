...
<body class="w3-mobile w3-sans-serif login">
  ...
  <div class="w3-container w3-padding w3-display-middle w3-text-white w3-white w3-card-4" style="width:400px">
    ...
    <h2 class="w3-center w3-monospace w3-wide w3-text-black">Forgot Password</h2>
    <p class="w3-center w3-monospace w3-text-black">Enter your email address</p>
                    <?php
                        if(count($errors) > 0){
                            ?>
                            <div class="w3-panel w3-pale-red w3-center w3-text-black w3-monospace w3-padding-small">
                                <?php 
  ...
  <i class="fa fa-user-circle w3-center w3-text-green w3-margin-right" style="font-size:30px;margin:auto"></i>
   <input class="w3-input w3-border w3-border-green" type="email" name="email" placeholder="Enter email address" required value="<?php echo $email ?>">
  </div>
  <br>
  <div class="w3-container w3-cell">
  <button type="submit" name="check-email" class="w3-center w3-panel w3-green w3-padding w3-half w3-margin-left w3-margin-top w3-center w3-text-black w3-hover-green" style="width:300px"><b>Continue</b></button>
</div>
   </form>
   </div>
 </div>
